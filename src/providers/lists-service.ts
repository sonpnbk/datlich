...
export class ListsService {
  ...
  public addList(thoigian:string){
    return this.database.addList(thoigian).then((list)=>{
    ...
    .then((data:any) =>{
          ...
          if(data){
            for(let list of data){
              localLists.push(new ListModel(list.thoigian, list.id));
              console.log(list.thoigian);
            }
          }
